...
class Movie(models.Model):
    ...
    description = models.TextField("Описание")
    poster = models.ImageField("Постер", blank=True,  upload_to="movies/", default="/movies/unnamed.jpg")
...
class MovieShots(models.Model):
    ...
    movie = models.ForeignKey(Movie, verbose_name="Фильм", related_name='shots', on_delete=models.CASCADE)
